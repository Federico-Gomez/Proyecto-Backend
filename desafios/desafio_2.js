...
class ProductManager {
    ...
    async addProduct(title, description, price, thumbnail, code, stock) {
        try {
            ...
            // Verificación para evitar error ENOENT por JSON vacío o inexistente.
            // if (this.#products == null) {
            //     this.#products = []; // Se inicializa el array de productos como un array vacío.
            // }
...
// manager.getProducts().then(products => console.log("All products:", products));
